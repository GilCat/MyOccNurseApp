...
public class VideoActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (temp == R.id.menu_settings)
        {
            startActivity(new Intent(this, SettingsActivity.class));
            return true;
        } else if (temp == R.id.menu_turn_speaker_off) {
    ...
    private void intializeUI() {
       ...
       goBack.setOnClickListener(goBackActionClickListener());
    }
    ...
    private View.OnClickListener goBackActionClickListener() {
        return v -> goBackButton();
